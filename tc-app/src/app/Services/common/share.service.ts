...
export class ShareService {
   ...
   */
  private createQRCodeModal(dataUrl: string, title: string, autoCloseDelay: number): void {
   ...
   */
  async shareLocation(lat: number, lng: number, label = 'Location'): Promise<void> {
   ...
   * @param label Optional location label
   */
  async showLocationQRCode(lat: number, lng: number, label = 'Location'): Promise<void> {
    const geoUri = this.generateGeoUri(lat, lng, label);
   ...
   * @param label Optional location label
   */
  async copyLocation(lat: number, lng: number, label = 'Location'): Promise<boolean> {
    const geoUri = this.generateGeoUri(lat, lng, label);
