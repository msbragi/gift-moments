...
export class AnalyticsService {
    ...
    public trackPageView(url: string): void {
        ...
        if (typeof gtag !== 'undefined') {
            ...
            const pageTitle = lastSegment ? `Time Caps - ${lastSegment}` : document.title;
     ...
     * Track custom event
     */
    public trackEvent(action: string, parameters?: {
     ...
     * Track user action
     */
    public trackUserAction(action: string, category: string = 'user_interaction'): void {
    ...
    */
     ...
     */
    public trackPurchase(transactionId: string, value: number, currency: string = 'EUR'): void {
        if (!this.isAnalyticsAllowed()) return;
