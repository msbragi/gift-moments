...
export class ApiService {
   ...
   */
  post<T>(endpoint: string, data: any, successMessage?: string, isFormData: boolean = false): Observable<T> {
   ...
   */
  patch<T>(endpoint: string, data: any, successMessage?: string): Observable<T> {
